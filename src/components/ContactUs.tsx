...
const ContactUs = () => {
    return (
        <section className='grid grid-cols-1 md:grid-cols-2 md:items-center gap-10 container mx-auto px-6  md:px-10 lg:px-0 mb-10 relative overflow-hidden'>
            <div className="rounded-full bg-gradient-to-r to-[#7140EB] from-[#FB8E8E] z-0 size-72 opacity-50 absolute -top-28 -right-40 filter blur-2xl" />
