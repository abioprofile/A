...
const GetStarted = ({ showBlur }: { showBlur?: boolean }) => {
    return (
        <section className='relative w-full my-10 md:my-20 px-6 md:px-10 overflow-hidden'>
            {showBlur && (
                <div className="bg-gradient-to-r to-[#7140EB] from-[#FB8E8E] z-0 size-72 opacity-50 absolute -bottom-28 -left-20 filter blur-3xl" />
            )}
