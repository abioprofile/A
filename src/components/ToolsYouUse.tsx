...
const ToolsYouUse = () => {
    return (
        <section className="relative mb-10 lg:mb-20 container px-6 md:px-10 lg:px-0 mx-auto overflow-hidden">
            <div className="rounded-full bg-gradient-to-r from-[#7140EB] to-[#FB8E8E] z-0 size-80 opacity-50 absolute -top-52 -right-40 filter blur-2xl" />
