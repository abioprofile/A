...
const platforms = [
  {
    name: "TikTok",
    link: "https://www.tiktok.com/@yourname",
    icon: "/assets/platform-icons/colored/Social=TikTok,Style=Original.svg",
    active: false,
  },
  {
    name: "Snapchat",
    link: "https://www.snapchat.com/add/yourname",
    icon: "/assets/platform-icons/colored/Social=Snapchat,Style=Original.svg",
    active: true,
  },
  {
    name: "Instagram",
    link: "https://www.instagram.com/yourname",
    icon: "/assets/platform-icons/colored/Social=Instagram,Style=Original.svg",
    active: true,
  },
  {
    name: "WhatsApp",
    link: "https://wa.me/+1234567890",
    icon: "/assets/platform-icons/colored/Social=WhatsApp,Style=Original.svg",
    active: false,
  },
  {
    name: "Pinterest",
    link: "https://pin.it/yourname",
    icon: "/assets/platform-icons/colored/Social=Pinterest,Style=Original.svg",
    active: true,
  },
  {
    name: "YouTube",
    link: "https://youtube.com/@yourname",
    icon: "/assets/platform-icons/colored/Social=YouTube,Style=Original.svg",
    active: true,
  },
  {
    name: "Twitter",
    link: "https://twitter.com/yourname",
    icon: "/assets/platform-icons/colored/Social=X ex Twitter,Style=Original.svg",
    active: false,
  },
];
...
const Toggle = ({ active }: { active: boolean }) => (
  <div
    className={`w-7 h-4 xl:w-9 xl:h-5 rounded-full relative flex-shrink-0 transition-colors duration-200 ${active ? "bg-[#5D2D2B]" : "bg-gray-200"}`}
  >
    <div
      className={`absolute top-0.5 w-3 h-3 xl:w-4 xl:h-4 rounded-full bg-white transition-transform duration-200 ${active ? "translate-x-3 xl:translate-x-4" : "translate-x-0.5"}`}
    />
  </div>
);
  ...
  return (
    <div className="bg-white border border-[#e5e5e5] shadow-[1px_1px_0px_0px_#000] xl:shadow-[3px_3px_0px_0px_#000] w-full px-2 py-1.5 xl:px-4 xl:py-3 flex flex-col gap-1 xl:gap-2">
      <div className="flex items-center gap-1.5 xl:gap-3">
        <GripVertical
          className="w-2.5 h-2.5 xl:w-4 xl:h-4 flex-shrink-0"
          style={{ color: "#FF0000" }}
        />
        <Image
          src={icon}
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <div className="flex items-center gap-0.5">
            <span className="text-[9px] xl:text-[13px] font-bold text-black leading-none">
              {name}
            </span>
            <Pencil className="w-2 h-2 xl:w-3 xl:h-3 text-gray-400" />
          </div>
          <div className="flex items-center gap-0.5 min-w-0">
            <span className="text-[7px] xl:text-[11px] text-gray-400 truncate max-w-[90px] xl:max-w-none">
              {link}
            </span>
