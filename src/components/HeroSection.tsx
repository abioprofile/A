...
const PROFILES: Profile[] = [
  {
    ...
    dotColor: "#1f4015",
    links: [
      { label: "Twitter",  icon: "/assets/platform-icons/black/Social=X ex Twitter,Style=Black.svg",
        style: { variant: "pill", bg: "transparent", color: "#1f4015", borderColor: "#1f4015",
                 shadow: "0 4px 14px rgba(31,64,21,0.3)", radius: "0px" } },
      { label: "Whatsapp", icon: "/assets/platform-icons/black/Social=WhatsApp,Style=Black.svg",
        style: { variant: "pill", bg: "transparent", color: "#1f4015", borderColor: "#1f4015",
                 shadow: "0 4px 14px rgba(31,64,21,0.3)", radius: "0px" } },
    ],
  },
  {
    ...
    dotColor: "#7c3aed",
    links: [
      { label: "Stream 'Closer'", icon: "/assets/platform-icons/black/Social=Spotify,Style=Black.svg",
        style: { variant: "solid", bg: "linear-gradient(135deg,#a855f7,#7c3aed)", color: "#fff",
                 shadow: "0 8px 24px rgba(168,85,247,0.55), 0 0 32px rgba(168,85,247,0.3)", radius: "14px" } },
      { label: "Apple Music", icon: "/assets/platform-icons/black/Social=Apple Music,Style=Black.svg",
        style: { variant: "solid", bg: "linear-gradient(135deg,#a855f7,#7c3aed)", color: "#fff",
                 shadow: "0 8px 24px rgba(168,85,247,0.55), 0 0 32px rgba(168,85,247,0.3)", radius: "14px" } },
      { label: "Book for shows", icon: "/assets/platform-icons/black/Social=Calendar,Style=Black.svg",
        style: { variant: "solid", bg: "linear-gradient(135deg,#a855f7,#7c3aed)", color: "#fff",
                 shadow: "4px 4px 0 rgba(168,85,247,0.55), 0 0 32px rgba(168,85,247,0.3)", radius: "14px" } },
    ],
  },
  {
    name:    "Faruk Saint",
    ...
    dotColor: "#5D2D2B",
    links: [
      { label: "Portfolio",       icon: "/assets/platform-icons/black/Social=Behance,Style=Black.svg",
        style: { variant: "brutal", bg: "#5D2D2B", color: "#Fff", shadow: "4px 4px 0 #000", radius: "0px" } },
      { label: "Get my NFC Card", icon: "/assets/platform-icons/black/Social=Link,Style=Black.svg",
        style: { variant: "brutal", bg: "#5D2D2B", color: "#Fff", shadow: "4px 4px 0 #000", radius: "0px" } },
      { label: "Book a call",     icon: "/assets/platform-icons/black/Social=Calendar,Style=Black.svg",
        style: { variant: "brutal", bg: "#5D2D2B", color: "#fff", shadow: "4px 4px 0 #000", radius: "0px" } },
      { label: "Snapchat",        icon: "/assets/platform-icons/black/Social=Snapchat,Style=Black.svg",
        style: { variant: "brutal", bg: "#5D2D2B", color: "#Fff", shadow: "4px 4px 0 #000", radius: "0px" } },
    ],
  },
  {
    name:    "Studio Clay",
    handle:  "studioclay.ng",
    bio:     "Ceramic artist · Lagos, Nigeria 🏺",
    avatar:  "CLAY",
    ...
    dotColor: "#db2777",
    links: [
      { label: "Shop ceramics", icon: "/assets/platform-icons/black/Social=Shop,Style=Black.svg",
        style: { variant: "solid", bg: "#db2777", color: "#fff", shadow: "0 8px 24px rgba(219,39,119,0.45)", radius: "18px" } },
      { label: "Book workshop", icon: "/assets/platform-icons/black/Social=Calendar,Style=Black.svg",
        style: { variant: "solid", bg: "#db2777", color: "#fff", shadow: "0 8px 24px rgba(219,39,119,0.45)", radius: "18px" } },
      { label: "Follow on IG",  icon: "/assets/platform-icons/black/Social=Instagram,Style=Black.svg",
        style: { variant: "solid", bg: "#db2777", color: "#fff", shadow: "0 8px 24px rgba(219,39,119,0.45)", radius: "18px" } },
      { label: "Email me",      icon: "/assets/platform-icons/black/Social=Gmail,Style=Black.svg",
        style: { variant: "solid", bg: "#db2777", color: "#fff", shadow: "0 8px 24px rgba(219,39,119,0.45)", radius: "18px" } },
    ],
  },
];
...
function useCardSize() {
  const [size, setSize] = useState({
    w: 280, h: 580, rotY: -22, rotX: 8, rotZ: 2.5,
    ringSm: 480, ringLg: 580, showBadges: true,
  });
  ...
  useEffect(() => {
    const update = () => {
      ...
      if (w < 380)
        setSize({ w: 230, h: 490, rotY: -6, rotX: 2, rotZ: 0.5,
                  ringSm: 290, ringLg: 350, showBadges: false });
      else if (w < 640)
        setSize({ w: 250, h: 520, rotY: -8, rotX: 3, rotZ: 1,
                  ringSm: 320, ringLg: 390, showBadges: false });
      else if (w < 1024)
        setSize({ w: 265, h: 550, rotY: -16, rotX: 6, rotZ: 2,
                  ringSm: 430, ringLg: 520, showBadges: true });
      else
        setSize({ w: 280, h: 580, rotY: -22, rotX: 8, rotZ: 2.5,
                  ringSm: 480, ringLg: 580, showBadges: true });
    };
    update();
...
const DotPattern = ({ color }: { color: string }) => {
  ...
  const cluster = [
    [20, 240],[35, 255],[50, 240],[25, 270],[40, 285],
    [60, 265],[70, 250],[55, 280],[80, 270],
  ];
  return (
    <svg width="100%" height="100%" viewBox="0 0 280 360"
      ...
      <polyline points="30,300 90,140 130,200 160,80 200,300"
...
// ─── RADIO WAVE CANVAS ───────────────────────────────────────────────────────
const RadioWaveBg = ({ targetRGB }: { targetRGB: [number, number, number] }) => {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const lerpRef   = useRef<[number, number, number]>([93, 45, 43]);
  const targetRef = useRef<[number, number, number]>(targetRGB);
  const tRef      = useRef(0);
  const rafRef    = useRef<number>(0);

  useEffect(() => { targetRef.current = targetRGB; }, [targetRGB]);
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      for (let i = 0; i < 3; i++)
        lerpRef.current[i] += (targetRef.current[i] - lerpRef.current[i]) * 0.02;
      const r = Math.round(lerpRef.current[0]);
      const g = Math.round(lerpRef.current[1]);
      const b = Math.round(lerpRef.current[2]);
      const cx = W / 2, cy = H / 2;
      const wt = tRef.current;

      for (let w = 0; w < 10; w++) {
        const ph     = ((wt * 0.3 + w / 10) % 1);
        const radius = ph * Math.max(W, H) * 0.9;
        ct.beginPath();
        ct.arc(cx, cy, radius, 0, Math.PI * 2);
        ct.strokeStyle = `rgba(${r},${g},${b},${(1 - ph) * 0.1})`;
        ct.lineWidth   = 1.5;
        ct.stroke();
      }

      const bCount = 60, bW = W / bCount;
      for (let i = 0; i < bCount; i++) {
        const x   = i * bW + bW / 2;
        const fq  = Math.sin(i * 0.25 + wt * 2)   * 0.45
                  + Math.sin(i * 0.65 + wt * 1.3) * 0.3
                  + Math.sin(i * 0.10 + wt * 0.8) * 0.25;
        const bh  = Math.abs(fq) * 50 + 5;
        ct.fillStyle = `rgba(${r},${g},${b},${0.07 + Math.abs(fq) * 0.05})`;
        ct.fillRect(x - 1.5, H - bh, 3, bh);
        ct.fillRect(x - 1.5, 0,      3, bh);
      }
      ...
      for (let l = 0; l < 4; l++) {
        ...
        for (let x = 0; x <= W; x += 3) {
          const y = H / 2
            + Math.sin(x * 0.008 + wt * 1.5 + l * 0.8) * (22 - l * 4)
            + Math.sin(x * 0.020 + wt * 0.8 + l * 1.6) * (10 - l * 2);
          ct.lineTo(x, y);
        }
        ct.strokeStyle = `rgba(${r},${g},${b},${0.05 - l * 0.01})`;
        ct.lineWidth   = 1;
        ct.stroke();
      }
...
const ProfileCard = ({ profile }: { profile: Profile }) => (
  ...
  >
    {/* WHITE TOP */}
    <div className="bg-white px-4 pt-6 pb-3 flex-shrink-0">
      <div className="flex items-center gap-2 mb-2.5">
        ...
        >
          <span className="text-white font-black text-[10px] tracking-[-0.3px] text-center leading-tight">
            {profile.avatar}
          </span>
        </div>
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 mb-0.5">
            ...
            <div className="w-[16px] h-[16px] rounded-full bg-[#FF0000] flex items-center
      ...
      <p className="text-[10px] text-[#444] leading-[1.5] font-medium mb-3">
        {profile.bio}
      </p>

      <div className="flex">
        <div className="inline-flex flex-col items-center relative pb-1">
          <span className="text-[10px] leading-none font-semibold">Links</span>
          <div className="absolute bottom-0 -left-0.5 -right-0.5 h-[2.5px] bg-[#FF0000] rounded-sm" />
        </div>
      </div>
    </div>
...
const TiltedCard = () => {
  ...
  return (
    ...
    >
      <div className="absolute -inset-16 md:-inset-32 z-0">
        <RadioWaveBg targetRGB={profile.waveRGB} />
      </div>
      ...
      <motion.div
        className="absolute rounded-full border border-dashed border-[#5D2D2B]/10
                   pointer-events-none"
        style={{ width: ringSm, height: ringSm, top: "50%", left: "50%",
                 marginLeft: -ringSm / 2, marginTop: -ringSm / 2, zIndex: 1 }}
        animate={{ rotate: 360 }}
      ...
      <motion.div
        className="absolute rounded-full border border-dashed border-[#5D2D2B]/[0.06]
                   pointer-events-none"
        style={{ width: ringLg, height: ringLg, top: "50%", left: "50%",
                 marginLeft: -ringLg / 2, marginTop: -ringLg / 2, zIndex: 1 }}
        animate={{ rotate: -360 }}
        transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
      />

      {showBadges && [
        { label: "NFC tap ↗",    icon: "✦",  bg: "#FED45C", color: "#000",
          left: -260, top: 100, delay: 0,   dur: 3.5 },
        { label: "43k views",    icon: "👀", bg: "#fff",    color: "#333",
          left: -275, top: 280, delay: 0.6, dur: 4.2 },
        { label: "Live",         icon: "🔴", bg: "#FF0000", color: "#fff",
          left: 200,  top: 80,  delay: 0.2, dur: 3.2 },
        { label: "12.8k clicks", icon: "🖱️", bg: "#fff",    color: "#333",
          left: 188,  top: 270, delay: 0.9, dur: 4.8 },
        { label: "74% CTR",      icon: "⚡", bg: "#3EB489", color: "#fff",
          left: 200,  top: 440, delay: 1.1, dur: 3.8 },
      ].map((b) => (
        <motion.div
          key={b.label}
          ...
          style={{
            ...
            left: `calc(50% + ${b.left}px)`, top: b.top,
...
const HeroSection = () => {
  return (
    <section className="min-h-screen w-full bg-[#FEF4EA] flex items-center
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20
        ...
        <div className="flex flex-col md:hidden items-center text-center">
          ...
          <motion.div
            ...
            className="w-full"
          >
            <h1 className="text-[42px] xs:text-[48px] sm:text-[56px]
                           leading-[0.88] trialheader font-[400]
                           text-[#5D2D2B] tracking-tight">
              Endless<br/>Connection.
            </h1>

            <div className="relative inline-block mt-1">
              <p className="text-[22px] xs:text-[24px] sm:text-[28px]
          ...
          >
            <div className="relative w-full">
              <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-black
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 220, damping: 18, delay: 0.5 }}
              >
                <Image src="/images/scribble.svg" alt="decoration"
                  width={160} height={160}
