...
const HeroSection = () => {
    return (
        <section className='relative w-full overflow-x-clip'>
            <div className="rounded-full bg-gradient-to-r from-[#7140EB] to-[#FB8E8E] opacity-30 absolute top-[19rem] md:right-[12rem] lg:-top-40 -right-10 lg:-right-5 z-20 size-[15rem] lg:size-[22rem] filter blur-3xl" />

            <div className="rounded-full bg-gradient-to-r from-[#7140EB] to-[#FB8E8E] opacity-30 absolute -bottom-10 lg:-bottom-16 left-5 md:left-[12rem] size-[15rem] lg:size-[22rem] z-20 filter blur-3xl" />
                ...
                <div className="max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        <div className="space-y-6 lg:space-y-8 relative">
                            ...
                            <div className="space-y-2 mt-5 bg-white z-50">
                                <h4 className="text-[#7140EB] cli z-50 uppercase font-bold text-center lg:text-start">
                                ...
                                <div className="space-y-7 relative inline-bloc text-center lg:text-left flex flex-col justify-center lg:justify-start">
                                    ...
                                    {/* <div className="relative inline-block">
                                        <p className="text-black z-50 text-base text-center lg:text-start font-medium max-w-md mx-auto lg:mx-0">
                                            Shop Everything, showcase your links, get closer to your audience. Do it all with A.bio.
                                        </p>
                                        <p className="w-full absolute top-0 left-0 clip z-50 text-base text-center lg:text-start font-medium max-w-md mx-auto lg:mx-0">
                                            Shop Everything, showcase your links, get closer to your audience. Do it all with A.bio.
                                        </p>
                                    </div> */}
                                    <div className="relative max-w-md mx-auto lg:mx-0 text-center lg:text-left">
                                        <p className="text-black z-50 text-base font-medium">
                                            Shop Everything, showcase your links, get closer to your audience. Do it all with A.bio.
                                        </p>
                                        <p className="absolute top-0 left-0 w-full clip z-50 text-base font-medium">
                                            Shop Everything, showcase your links, get closer to your audience. Do it all with A.bio.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="relative flex justify-center lg:justify-start mt-8 lg:mt-10">
                            <div className="relative overflow-hidden w-full max-w-[350px] sm:max-w-[400px] size-[400px] lg:max-w-[600px] lg:size-[600px] mx-auto">
                                ...
                                <Image
                                    ...
                                    priority={true}
                                    blurDataURL='/images/hero-image.svg'
                                />
                            </div>

                            {/* Cloud decorations */}
                            {/* <div className="rounded-full bg-gradient-to-r from-[#7140EB] to-[#FB8E8E] opacity-30 absolute -top-[7.5rem] md:-right-20 lg:-top-40 -right-10 lg:-right-5 z-20 size-[15rem] lg:size-[22rem] filter blur-3xl" /> */}
                            <div className="absolute bg-transparent bg-blend-multiply -top-[7.5rem] md:right-[12rem] lg:-top-40 -right-10 lg:-right-5 size-[15rem] lg:size-[22rem] z-20">
                                <Image
                                    ...
                                    fill
                                    className="object-contain mix-blend-soft-light opacity-40"
                                    priority={true}
                                />
                            </div>

                            {/* <div className="rounded-full bg-gradient-to-r from-[#7140EB] to-[#FB8E8E] opacity-30 absolute -bottom-10 lg:-bottom-16 -left-5 md:-left-5 size-[15rem] lg:size-[22rem] z-20 filter blur-3xl" /> */}
                            <div className="absolute -bottom-10 lg:-bottom-16 -left-5 md:left-[12rem] size-[15rem] lg:size-[22rem] z-20">
                                <Image
                                    src="/icons/cloud.svg"
                                    alt="Cloud decoration"
                                    fill
