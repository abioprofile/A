        ...
        <section className='w-full relative overflow-x-clip mb-16 lg:mb-20'>
            <div className='mb-10 lg:mb-20 px-6 md:px-10 lg:px-0 container mx-auto'>
                <div className='bg-[#E9E0FE]  px-5 py-10 lg:p-10 xl:mx-20 z-40 relative'>
                    <h4 className='text-[#7140EB] text-[13px] font-bold text-center lg:mt-10 uppercase'>MAKE IT EASY</h4>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
                        <div className='bg-[#F5F1FF] p-10  flex flex-col justify-center items-center py-10 space-y-3 aspect-[1/1]'>
                            <div className='p-5 bg-[#B698FF] rounded-full'>
                                <Image src={"/icons/archieve.svg"} alt='' width={50} height={50} className='size-7' />
                            </div>
                            <div className='text-center mt-2 space-y-2'>
                                <h1 className='font-semibold text-xl'>Create</h1>
                                <p className='text-[12px] font-thin text-center'>Customize your unique A.bio pageand
                        ...
                        <div className='bg-[#F5F1FF] p-10  flex flex-col justify-center items-center py-10 space-y-3 aspect-[1/1]'>
                            ...
                            <div className='text-center mt-2 space-y-2'>
                                <h1 className='font-semibold text-xl'>Integrate</h1>
                                <p className='text-[12px] font-thin text-center'>Connect all your favorite platforms - from
                        ...
                        <div className='bg-[#F5F1FF] p-10  flex flex-col justify-center items-center py-10 space-y-3 aspect-[1/1]'>
                            ...
                            <div className='text-center mt-2 space-y-2'>
                                ...
                                <p className='text-[12px] font-thin text-center'>Promote your A.bio Link everywhere
