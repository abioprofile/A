...
const OffersPage = () => {
    ...
    return (
        <main className="min-h-screen container flex flex-col mx-auto py-16 lg:py-10 relative">
            ...
            <div className="max-w-2xl mx-auto mb-10 md:mb-14 flex justify-center items-center flex-col">
                ...
                <p className="font-semibold px-16 text-center">
                        ...
                        <div className='h-56 w-full mx-auto'>
                            <div className='flex flex-col space-y-3 w-full h-full justify-center items-center'>
                                ...
                                <CardHeader className='w-full flex flex-col space-y-0 py-0'>
                                    ...
                                    <CardDescription className='flex justify-center text-center text-xs w-full text-white font-semibold'>{offer.description}</CardDescription>
                                </CardHeader>
                            </div>
                        </div>
