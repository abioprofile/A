              ...
              <div className="w-full h-full bg-white overflow-hidden relative flex flex-col">
                ...
                >
                  ...
                  <div className="mt-4 flex absolute bottom-0 gap-8">
                    <TabButton tab="links" label="Links" layoutId="activeTabDesktop" />
                    {hasStreamingLinks(links) && (
                      <TabButton tab="listen" label="Listen" layoutId="activeTabDesktop" />
                    )}
                    {hasMenuTab && (
                      <TabButton tab="menu" label="Menu" layoutId="activeTabDesktop" />
                    )}
                  </div>
                </motion.div>
            ...
            >
              ...
              <div className="mt-4 flex absolute bottom-0 gap-8">
                <button
                  ...
                  className="relative flex flex-col items-center pb-2 group"
                >
                  <span className={`text-[11px] -mb-2 font-medium transition-colors ${activeTab === "links" ? "text-black" : "text-gray-400"}`}>
                    Links
                  </span>
                  {activeTab === "links" && (
                    <motion.div layoutId="activeTabMobile" className="h-[3px] absolute -bottom-0.5 w-6 bg-red-500" />
                  )}
                </button>
                {hasStreamingLinks(links) && (
                  <button
                    ...
                    className="relative flex flex-col items-center pb-2 group"
                  >
                    <span className={`text-[11px] -mb-2 font-medium transition-colors ${activeTab === "listen" ? "text-black" : "text-gray-400"}`}>
                      Listen
                    </span>
                    {activeTab === "listen" && (
                      <motion.div layoutId="activeTabMobile" className="h-[3px] absolute -bottom-0.5 w-6 bg-red-500" />
