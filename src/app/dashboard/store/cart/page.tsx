  ...
  return (
    <div>
      <div className="flex flex-col mt-6 space-y-1 items-center mb-4">
        ...
        <Link href="/dashboard/store" className=" hover:underline text-sm">
          Continue ordering
        </Link>
      </div>
      ...
      <div className="p-14 bg-white max-w-5xl mx-auto space-y-6">
        ...
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div className="flex justify-between border-b-1 border-b-black pb-2 font-bold text-lg md:text-xl uppercase tracking-wider">
              <span>Product</span>
              <span>Total</span>
            </div>
            ...
            {cart.map((item, idx) => (
              <div key={idx} className="flex flex-col md:flex-row items-center justify-between border-b-1 border-b-black pb-4">
                ...
                <div className="flex flex-col md:items-end md:gap-2 mt-4 md:mt-0">
                  <p className="font-bold text-lg md:text-xl">₦{item.price.toLocaleString()}</p>
                  <button
            ...
            <div className="flex flex-col md:flex-row justify-between gap-8 border-b pb-4">
              <div className="space-y-2 text-xs font-thin">
              ...
              <div className="w-full md:w-1/3 space-y-2">
                ...
                <div className="flex justify-between text-sm font-semibold border-t-1 border-t-black pt-2">
                  <span>Delivery</span>
                  <span>Free</span>
                </div>
              </div>
