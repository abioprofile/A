                ...
                <div className='p-16 space-y-5 bg-[#E9E0FE] rounded-[30px] lg:rounded-none lg:rounded-l-[30px] flex flex-col justify-center'>
                    ...
                    <form action="" className='space-y-4'>
                        <div className='flex gap-4'>
                            <Input placeholder='First Name' className='bg-white border-none' />
                            <Input placeholder='Last Name' className='bg-white border-none' />
                        </div>
                        <Input className='w-full! bg-white border-none' placeholder='Email' />
                        <Input className='w-full! bg-white border-none' placeholder='Subject' />
                        <Textarea className='w-full! [field-sizing:initial]! bg-white border-none' placeholder='Message' rows={5} />
